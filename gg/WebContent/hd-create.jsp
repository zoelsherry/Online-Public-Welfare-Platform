...
<%	String UN=new String(request.getParameter("orgName").getBytes("ISO-8859-1"),"utf-8");

	%>
<div class="login">
    <div class="loginTitle"><h1>创建一个同城活动</h1></div>
  	<div class="huodongContent" style="height:900px;">
    	<form id="form" name="form" method="post" action="servlet/activityAdd">
    	<div class="line">
    	 <div class="registerWord">主办方：(*)</div>
    	<div class="loginFrame"><input name="orgName"  type="text" value=<%= UN%> size="30" width="200" height="30"/></div>
    	</div>
        <div class="line">
            <div class="registerWord">标题：(*)</div>
            <div class="loginFrame"><input name="actName" type="text" size="30" width="200" height="30" /></div>
        </div>
        <div class="line">
        ...
        <div class="line">
            ...
            <div class="loginFrame"><input name="startTime" type="text" size="30" width="200" height="30" /></div>
        </div>
        <div class="line">
            <div class="registerWord">结束时间：(*)</div>
            <div class="loginFrame"><input name="endTime" type="text" size="30" width="200" height="30" /></div>
        </div>
        <div class="line">
            <div class="registerWord">地点：(*)</div>
            <div class="loginFrame"><input name="address" type="text" size="30" width="200" height="30" /></div>
        </div>
